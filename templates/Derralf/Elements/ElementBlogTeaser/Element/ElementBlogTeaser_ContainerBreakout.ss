                    ...
                    <div class="row isotope-container">
                        <% loop $BlogPosts %>
                            <div class="col-sm-4 col-md-4 isotope-item">
                                <div class="card">
                                    <% if $FeaturedImage %><a href="$Link"><img class="card-img-top img-responsive forced" src="$FeaturedImage.ScaleWidth(360).Link" alt="$Title.ATT"></a><% end_if %>
                                    <div class="card-block">
                                        <div class="post-date h3">$PublishDate.Format('y MMMM dd')</div>
                                        <h2 class="card-title"><a href="$Link"><% if $MenuTitle %>$MenuTitle<% else %>$Title<% end_if %></a></h2>
